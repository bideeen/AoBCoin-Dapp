...
import abi from "./contracts/AoB.json";
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">AoB Coin Project</span>
        <img className="inline p-3 ml-2" src="https://i.imgur.com/5JfHKHU.png" alt="AoB Coin" width="60" height="30" />
      </h2>
